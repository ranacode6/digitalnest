  ...
  return (
    <footer className="py-16 bg-[#0E172B] bg-[url('/images/home/footer-bg.png')] p-5 md:px-14 lg:px-28 bg-bottom bg-cover">
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col justify-center md:justify-start p-4 gap-2 items-center md:items-start mb-5 md:mb-0">
          <div className="w-fit flex flex-col md:justify-start md:items-start justify-center items-center">
            ...
            />
            <h1 className="text-2xl font-bold">DigitalNest</h1>
          </div>
          ...
          <div className="flex mt-3">
            ...
            {/* Email Svg */}
            <Link
              href="mailto:DigitalNest6@gmail.com"
            ...
            {/* LinkedIn Svg */}
            <Link
              href="https://linkedin.com/in/DigitalNest6"
      ...
      <div className="flex flex-col md:flex-row justify-between items-center">
        <p>© 2024 DigitalNest™. All Rights Reserved.</p>
              ...
              <div className="flex min-h-full items-center justify-center p-4">
                ...
                >
                  ...
                  <p className="mt-1 text-sm/6 text-gray-500 dark:text-gray-400">
                    Effective date: December 19, 2022 DigitalNest
                    (&rdquo;us&rdquo;, &rdquo;we&rdquo;, or &rdquo;our&rdquo;)
                    operates the www.DigitalNestautomation.com website
                    (hereinafter referred to as the &rdquo;Service&rdquo;). This
                    ...
                    and use of information in accordance with this policy. We
                    collect and use your personal data to provide and improve
                    the Service. We may also use it to communicate with you,
                    such as to send nDigitalNestletters or marketing materials.
                    You can opt out of receiving these communications at any
                    time. We use cookies and similar tracking technologies to
                    track activity on our Service. You can instruct your browser
                    to refuse all cookies or to indicate when a cookie is being
                    sent. However, if you do not accept cookies, you may not be
                    able to use some parts of our Service. We may disclose your
                    personal data in response to legal requests, to protect our
                    rights and the rights of others, and to prevent harm. We
                    reserve the right to update this Privacy Policy at any time.
                    We encourage you to review it regularly to stay informed of
                    any changes. If you have any questions or concerns about our
                    collection, use, or disclosure of your personal data, please
                    contact us at office@DigitalNestautomation.com
                  </p>
