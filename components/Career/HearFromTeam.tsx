  ...
  const reviews: review[] = [
    {
      ...
      review:
        "At DigitalNest, we're not just about software &hyphen; we're about your journey. Join our crew of ambitious minds, where innovation thrives and collaboration reigns. Work hard, yes, but we''re all about that balance, ensuring your career grows hand in hand with your passions. Let's chase dreams together!",
      name: 'Rana Ahammed',
    ...
    },
    {
      ...
      review:
        "I am incredibly proud to be a part of DigitalNest as a UI/UX Designer. The dynamic and innovative environment here has truly allowed me to thrive and continuously push the boundaries. From collaborating with talented teams, every day brings new challenges and opportunities for growth. The supportive leadership and emphasis on creativity make DigitalNest, an exceptional place to shape my future. I'm grateful for the chance to contribute my skills and be a part of this amazing journey",
    ...
    },
    {
      ...
      review:
        'DigitalNest is such a company where the work environment is highly satisfying. OCB of our company is really praiseworthy. Perceived support from coworkers and superiors is outstanding. There is no counterproductive work behavior. DigitalNest team always gives me motivating environment though there are challenges in work and I have gained a lot experience and skills working here.',
      name: 'Hasibul Hasan',
